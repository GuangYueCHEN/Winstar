...
public class MyRecordReader2 extends RecordReader<LongWritable, Text> {

    private static final Log LOG = LogFactory.getLog(MyRecordReader2.class);
    ...
    private byte[] separator = "</d>".getBytes();
